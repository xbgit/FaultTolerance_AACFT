...
class Scenario(BaseScenario):
    ...
    def adversary_reward(self, agent, world):
        """Reward for adversaries: penalizes communication failures, boundary exits, and distance to prey;
        rewards collisions with prey and penalizes collisions with other adversaries."""
        rew = 0
        if agent.id == 0:
